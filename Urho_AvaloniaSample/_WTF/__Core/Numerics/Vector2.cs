...
namespace WTF.Numerics
{
    ...
    {
        public class Array : List<Vector2> // NOTE: this <Vector2> would be auto-gen'ed to the specified preferred library -- like Urho... or defaults to WTF.Numerics.Vector2
        {
        }
