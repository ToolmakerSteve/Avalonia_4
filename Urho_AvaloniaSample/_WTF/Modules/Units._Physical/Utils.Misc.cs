...
namespace WTF.Units
{
    ...
    public static partial class Utils
    {
        ...
        public delegate Distance3 TwoDWithZ_P3DDelegate(Distance2 xy, double z);
        public delegate Distance2 ThreeD_P2DDelegate(Distance3 xyz);
        ...
        //        ///     ''' <returns></returns>
        //        public static IEnumerable<Distance2> BackwardsNoDup(this IList<Distance2> list1, Distance2? previousT, double tolerance = EpsilonForOne)
        //        {
        ...
        //        ///     ''' <param name="tolerance"></param>
        //        ///     ''' <returns></returns>
        //        public static IEnumerable<Distance2> ForwardNoDup(this IList<Distance2> list1, Distance2? previousT, double tolerance = EpsilonForOne)
        //        {
        //            int iLast = LastIndex(list1);
        ...
        //        }
        //        // A reasonable "toleranceFraction" is ScaledToleranceDouble. Larger if multiple operations may accumulate error.
        //        public static bool NearlyEquals_ScaledTolerance(this Distance2 p1, Distance2 p2, double toleranceFraction)
        //        {
        ...
        //        public static void Swap(ref Distance2 ptdFirst, ref Distance2 ptdSecond)
        //        {
        //            Distance2 tmp = ptdFirst;
        //            ptdFirst = ptdSecond;
        //            ptdSecond = tmp;
        //        }

        //        public static void Swap(ref Distance3 ptdFirst, ref Distance3 ptdSecond)
        //        {
        //            Distance3 tmp = ptdFirst;
        //            ptdFirst = ptdSecond;
        //            ptdSecond = tmp;
        //        }
        ...
        public static double CalcDistance2(double x1, double y1, double x2, double y2)
        {
            return Math.Sqrt(DistanceSquared2D(x1, y1, x2, y2));
        }
        public static Distance CalcDistance2(Distance x1, Distance y1, Distance x2, Distance y2)
        {
            return DistanceSquared2D(x1, y1, x2, y2).Sqrt();
        }

        public static Distance CalcDistance2(Distance2 p1, Distance2 p2)
        {
            return DistanceSquared2D(p1.X, p1.Y, p2.X, p2.Y).Sqrt();
        }

        public static Distance CalcDistance2(Distance3 p1, Distance3 p2)
        {
            return CalcDistance2(p1.X, p1.Y, p2.X, p2.Y);
        }
        ...
        public static Distance2 Lerp(Distance2 a, Distance2 b, double wgtB)
        {
            return new Distance2(Lerp(a.X, b.X, wgtB), Lerp(a.Y, b.Y, wgtB));
        }
        public static Distance3 Lerp(Distance3 a, Distance3 b, double wgtB)
        {
        ...
        public static Distance2 Average(Distance2 a, Distance2 b)
        {
            return Lerp(a, b, 0.5);
        }
        public static Distance3 Average(Distance3 a, Distance3 b)
        {
            return Lerp(a, b, 0.5);
        }

        public static Distance2 Average(IList<Distance2> points)
        {
            var count = 0;
            ...
            if (count == 0)
                return new Distance2(Distance.Zero, Distance.Zero);
            else
                return new Distance2(sumX / count, sumY / count);
        }
        ...
        public static double WgtFromResult(Distance2 pA, Distance2 pB, Distance2 resultPt)
        {
            Distance2 dB = pB - pA;
            Distance2 dResult = resultPt - pA;
        ...
        // inNear:inGoal:inFar corresponds to outNear:outGoal:outFar.
        // CAUTION: "inGoal" - maybe it should have been FIRST parameter, but it isn't.
        public static Distance2 MatchingLerp(double inNear, double inFar, double inGoal, Distance2 outNear, Distance2 outFar)
        {
            double wgt = WgtFromResult(inNear, inFar, inGoal);
            // outGoal
            return Lerp(outNear, outFar, wgt);
        ...
        public static Distance2 LerpXY(Distance2 a, Distance2 b, double2 wgtB)
        {
            return new Distance2(Lerp(a.X, b.X, wgtB.X), Lerp(a.Y, b.Y, wgtB.Y));
        }
        ...
        public static Distance2 Lerp2D(double2 xyWgt, Distance2 X0Y0, Distance2 X1Y0, Distance2 X0Y1, Distance2 X1Y1)
        {
            Distance2 xY0 = Lerp(X0Y0, X1Y0, xyWgt.X);
            Distance2 xY1 = Lerp(X0Y1, X1Y1, xyWgt.X);

            Distance2 xy = Lerp(xY0, xY1, xyWgt.Y);
            return xy;
        }
        ...
        //public static Distance2 InverseLerp2D(Distance2 xy, Distance2 X0Y0, Distance2 X1Y0, Distance2 X0Y1, Distance2 X1Y1)
        //{
        //    // ----> Main Work, Pass 1 <----
        //    Distance2 xyWgt = _InverseLerp2D_Pass1(xy, X0Y0, X1Y0, X0Y1, X1Y1);

        //    // Verify
        //    Distance2 xy_verify = Lerp2D(xyWgt, X0Y0, X1Y0, X0Y1, X1Y1);

        //    double newError = CalcDistance2(xy, xy_verify);
        ...
        //    double tolerance = CalcDistance2(X0Y0, X1Y1) * 0.00005; // 0.0001 ' 0.0002
        ...
        //        newError = CalcDistance2(xy, xy_verify);
        ...
        //private static Distance2 _InverseLerp2D_PassN(Distance2 xyWgt1, Distance2 xy, Distance2 X0Y0, Distance2 X1Y0, Distance2 X0Y1, Distance2 X1Y1)
        //{
        ...
        //    Distance2 XguessY0 = Lerp(X0Y0, X1Y0, xWgt);
        //    Distance2 XguessY1 = Lerp(X0Y1, X1Y1, xWgt);
        //    double yWgt2;
        ...
        //    Distance2 Xguess_closest = ClosestPointOnLine2D_AndT(xy, XguessY0, XguessY1, yWgt2);

        //    double yWgt = xyWgt1.Y;
        //    Distance2 X0Yguess = Lerp(X0Y0, X0Y1, yWgt);
        //    Distance2 X1Yguess = Lerp(X1Y0, X1Y1, yWgt);
        //    double xWgt2;
        //    // y params => xWgt2 ("x" is not a typo).
        //    Distance2 Yguess_closest = ClosestPointOnLine2D_AndT(xy, X0Yguess, X1Yguess, xWgt2);

        //    // Dim Xguess_error As Double = CalcDistance2(xy, Xguess_closest)
        //    // Dim Yguess_error As Double = CalcDistance2(xy, Yguess_closest)
        ...
        //private static Distance2 _InverseLerp2D_Pass1(Distance2 xy, Distance2 X0Y0, Distance2 X1Y0, Distance2 X0Y1, Distance2 X1Y1)
        //{
        //    double wx0;
        ...
        //    Distance2 xyWgt = new Distance2(wx, wy);
        //    return xyWgt;
        //}
        ...
        //public static Distance2 InverseLerp2D_A(Distance2 xy, Distance2 X0Y0, Distance2 X1Y0, Distance2 X0Y1, Distance2 X1Y1)
        //{
        //    double x = xy.X;
        ...
        //            public PolarPoint(Distance2 pt) : this(pt.X.Value, pt.Y.Value)
        //            {
        //            }
        ...
        //            public static PolarPoint operator +(PolarPoint p1, Distance2 p2)
        //            {
        //                Distance2 sum = p1.AsPoint2D() + p2;
        //                return new PolarPoint(sum);
        //            }

        //            public Distance2 AsPoint2D()
        //            {
        //                // TODO: How will GeoContext deal with units?
        //                Distance2 pt = new Distance2(Length * Math.Cos(Angle), Length * Math.Sin(Angle), null);
        //                return pt;
        //            }
        //        }
