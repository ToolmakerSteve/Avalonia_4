...
namespace WTF.Units
{
    ...
    public static partial class Utils
    {
        ...
        public static bool NearlyEquals(this Distance2 p1, Distance2 p2, double tolerance = EpsilonForOne)
        {
        ...
        //        public static double getAngleDegrees(Distance2 origin, Distance2 aimPt)
        //        {
        ...
        //        public static float headingAsAngleRadians2D(Distance2 heading)
        //        {
        ...
        //        //{
        //        //    TEST_rotation1(new Distance2(2, 1));
        //        //    TEST_rotation1(new Distance2(2, -1));
        //        //    TEST_rotation1(new Distance2(-2, 1));
        //        //    TEST_rotation1(new Distance2(-2, -1));
        //        //    TEST_rotation1(new Distance2(1, 2));

        //        //       void TEST_rotation1(Distance2 heading)
        //        //    {
        //        //        var landing = new Distance2(0.5, 0.5) + heading;
        ...
        //        public static Distance2 moveOnHeading(Distance2 origin, Distance2 heading, double distance)
        //        {
        //            return new Distance2(origin.X + distance * heading.X, origin.Y + distance * heading.Y);
        //        }

        //        public static Distance2 moveOnAngleRadians(Distance2 origin, float angleRadians, double distance)
        //        {
        //            Distance2 heading = angleRadiansAsHeading(angleRadians);
        //            return moveOnHeading(origin, heading, distance);
        //        }

        //        // Ignores origin.Z.
        //        public static Distance2 moveOnAngleRadians(Distance3 origin, float angleRadians, double distance)
        //        {
        //            Distance2 heading = angleRadiansAsHeading(angleRadians);
        //            return moveOnHeading(new Distance2(origin.X, origin.Y), heading, distance);
        //        }


        //        // ========== absDelta, distance ==========

        //        public static Distance2 absDelta(Distance2 p1, Distance2 p2)
        //        {
        //            double dX = p2.X - p1.X;
        //            double dY = p2.Y - p1.Y;

        //            return new Distance2(Math.Abs(dX), Math.Abs(dY));
        //        }
        ...
        //        public static double distance(Distance2 p1, Distance2 p2)
        //        {
        //            double dX = p2.X - p1.X;
        //            double dY = p2.Y - p1.Y;
        ...
        //        public static double distance_approx(Distance2 p1, Distance2 p2)
        //        {
        ...
        //        public static double distance2D(Distance3 p1, Distance3 p2)
        //        {
        //            double dX = p2.X - p1.X;
        //            double dY = p2.Y - p1.Y;
        ...
        //        public static double distanceSquared(Distance2 p1, Distance2 p2)
        //        {
        //            double dX = p2.X - p1.X;
        //            double dY = p2.Y - p1.Y;
        ...
        //        public static double distanceSquared(Distance3 p1, Distance3 p2)
        //        {
        //            double dX = p2.X - p1.X;
        //            double dY = p2.Y - p1.Y;
        ...
        //        public static double distanceSquared_approx(Distance2 p1, Distance2 p2, Distance2 scale)
        //        {
        ...
        //        // aka GeoDistance;
        //        public static double calculateDistanceDD_AED(Distance2 p1, Distance2 p2)
        //        {
        //            return calculateDistanceDD_AED(p1.X, p1.Y, p2.X, p2.Y);
        //        }

        //        // x=longitude, y= latitude.
        //        public static double calculateDistanceDD_AED(Distance3 p1, Distance3 p2, bool approximate = false)
        //        {
        //            if (p1 == null || p2 == null)
        ...
        //        // Sets fields of outXY. (Avoids creating a Distance2.Double instance.)
        //        public static void lerpXY(double ax, double ay, double bx, double by, double wgtB, Distance2 outXY)
        //        {
        //            outXY.X = lerp(ax, bx, wgtB);
        //            outXY.Y = lerp(ay, by, wgtB);
        //        }

        //        public static Distance2 lerpXY(double ax, double ay, double bx, double by, double wgtB)
        //        {
        //            return new Distance2(lerp(ax, bx, wgtB), lerp(ay, by, wgtB));
        //        }

        //        public static Distance2 lerpXY(Distance2 a, Distance2 b, double wgtB)
        //        {
        //            return new Distance2(lerp(a.X, b.X, wgtB), lerp(a.Y, b.Y, wgtB));
        //        }

        //        // xyWgt in (0..1, 0..1).
        //        public static Distance2 lerp2D(Distance2 xyWgt, Distance2 x0y0, Distance2 x1y0, Distance2 x0y1, Distance2 x1y1)
        //        {
        //            Distance2 xY0 = lerpXY(x0y0, x1y0, xyWgt.X);
        //            Distance2 xY1 = lerpXY(x0y1, x1y1, xyWgt.X);
        //            return lerpXY(xY0, xY1, xyWgt.Y);
        //        }

        //        public static Distance3 lerp3D(Distance3 a, Distance3 b, double wgtB)
        //        {
        //            return new Distance3(lerp(a.X, b.X, wgtB), lerp(a.Y, b.Y, wgtB), lerp(a.Z, b.Z, wgtB));
        //        }


        //        // Returns (x, y), where each coordinate is in (0, 1) if it is within image.
        //        public static Distance2 inverseLerpWithZ(double ptx, double pty, double x0y0x, double x0y0y, double x1y0x, double x1y0y, double x0y1x, double x0y1y, double x1y1x, double x1y1y, double originZ, double ZtoY, double altitude)
        //        {

        //            Distance2 xyWgt = inverseLerp2D(ptx, pty, x0y0x, x0y0y, x1y0x, x1y0y, x0y1x, x0y1y, x1y1x, x1y1y);

        //            //		// Verify
        //            //		Distance2 xyWgt = lerp2D(new Distance2(outx[0], outy[0]),
        //            //				   			   new Distance2(x0y0x, x0y0y),
        //            //				   			   new Distance2(x1y0x, x1y0y),
        //            //				   			   new Distance2(x0y1x, x0y1y),
        //            //				   			   new Distance2(x1y1x, x1y1y));
        //            //		if (!nearlyEquals(xyWgt, new Distance2(ptx, pty), 0.000002))
        //            //			Dubious();
        ...
        //        public static Distance2 inverseLerp2D(double ptx, double pty, double x0y0x, double x0y0y, double x1y0x, double x1y0y, double x0y1x, double x0y1y, double x1y1x, double x1y1y)
        //        {

        //            Distance2 xyWgt = inverseLerp2D_pass1(ptx, pty, x0y0x, x0y0y, x1y0x, x1y0y, x0y1x, x0y1y, x1y1x, x1y1y);

        //            // Too much trouble passing around all the individual x's and y's.
        //            // BUT COST: new/GC.
        //            Distance2 xy = new Distance2(ptx, pty);
        //            Distance2 x0y0 = new Distance2(x0y0x, x0y0y);
        //            Distance2 x1y0 = new Distance2(x1y0x, x1y0y);
        //            Distance2 x0y1 = new Distance2(x0y1x, x0y1y);
        //            Distance2 x1y1 = new Distance2(x1y1x, x1y1y);

        //            Distance2 xyVerify = lerp2D(xyWgt, x0y0, x1y0, x0y1, x1y1);
        ...
        //        // Sets outx[0], outy[0].
        //        public static Distance2 inverseLerp2D(double ptx, double pty, double x0y0x, double x0y0y, double x1y0x, double x1y0y, double x0y1x, double x0y1y, double x1y1x, double x1y1y, double[] outx, double[] outy)
        //        {
        ...
        //        private static Distance2 inverseLerp2D_pass1(double ptx, double pty, double x0y0x, double x0y0y, double x1y0x, double x1y0y, double x0y1x, double x0y1y, double x1y1x, double x1y1y)
        //        {
        ...
        //            return new Distance2(wx, wy);
        //        }

        //        // Calls closestPointOnLine_AndT with allowExtendedT=true, so can return a point outside of the image.
        //        // This is needed, because the point BEFORE taking z into account might fall outside.
        //        private static Distance2 inverseLerp2D_passN(Distance2 xyWgt1, Distance2 xy, Distance2 x0y0, Distance2 x1y0, Distance2 x0y1, Distance2 x1y1)
        //        {
        //            // NOTE: the "x-guess" line yields an improved approximation to yWgt
        //            // (yWgt2);
        //            // the "y-guess" line yields improved xWgt.
        //            double xWgt = xyWgt1.X;
        //            Distance2 XguessY0 = lerpXY(x0y0, x1y0, xWgt);
        //            Distance2 XguessY1 = lerpXY(x0y1, x1y1, xWgt);
        ...
        //            Distance2 X0Yguess = lerpXY(x0y0, x0y1, yWgt);
        //            Distance2 X1Yguess = lerpXY(x1y0, x1y1, yWgt);
        //            // y params => xWgt2 ("x" is not a typo).
        //            closestPointOnLine_AndT(xy, X0Yguess, X1Yguess, out double xWgt2, true);

        //            // double Xguess_error = CalcDistance2(xy, Xguess_closest)
        //            // double Yguess_error = CalcDistance2(xy, Yguess_closest)

        //            // Improved guess.
        //            return new Distance2(xWgt2, yWgt2);
        //        }
        ...
        //        public static Distance2 closestPointOnLine_AndT(double ptx, double pty, double p1x, double p1y,
        ...
        //            return new Distance2(closestx, closesty);
        //        }

        //        public static Distance2 closestPointOnLine_AndT(Distance2 pt, Distance2 p1, Distance2 p2, out double t, bool allowExtendedT)
        //        {
        ...
        //        public static Distance3 closestPointOnLine_AndT(Distance3 pt, Distance3 p1, Distance3 p2, out double t)
        //        {
        //            bool allowExtendedT = false;
        //            Distance2 pt2 = closestPointOnLine_AndT(pt.X, pt.Y, p1.X, p1.Y, p2.X, p2.Y, out t, allowExtendedT);


        //            return new Distance3(pt2.X, pt2.Y, lerp(p1.Z, p2.Z, t));
        //        }

        //        // closest is measured using 2D distances.
        //        // pts in geo coords.
        //        public static Distance3 closestPointOnLine_AndT_geo(Distance3 geoPt, Distance3 geoP1, Distance3 geoP2, double[] t)
        //        {
        //            bool allowExtendedT = false;
        ...
        //            Distance2 mayaPt = context.FromWGS84(geoPt.To2D());
        //            Distance2 mayaP1 = context.FromWGS84(geoP1.To2D());
        //            Distance2 mayaP2 = context.FromWGS84(geoP2.To2D());

        //            double t0;
        //            Distance2 mayaClosest = closestPointOnLine_AndT(mayaPt.X, mayaPt.Y, mayaP1.X, mayaP1.Y, mayaP2.X, mayaP2.Y, out t0, allowExtendedT);
        //            t[0] = t0;

        //            Distance2 geoClosest = context.ToWGS84(mayaClosest);
        //            return new Distance3(geoClosest.X, geoClosest.Y, lerp(geoP1.Z, geoP2.Z, t0));
        //        }

        //        public static Distance2 closestPointOnLine_AndT_geo(Distance2 geoPt, Distance2 geoP1, Distance2 geoP2, double[] t)
        //        {
        //            bool allowExtendedT = false;
        //            // TODO: How pick an appropriate orthographic coordinate system?
        //            throw new NotImplementedException("closestPointOnLine_AndT_geo");
        //            Geo.IContext context;
        //            Distance2 mayaPt = context.FromWGS84(geoPt);
        //            Distance2 mayaP1 = context.FromWGS84(geoP1);
        //            Distance2 mayaP2 = context.FromWGS84(geoP2);
        ...
        //        {
        //            Distance2 closest = closestPointOnLine_AndT(ptx, pty, p1x, p1y, p2x, p2y, out t, allowExtendedT);
        ...
        //        public static Distance3 pointAheadOnPointSequence(Distance3 startGeo, Distance3[] ptsGeo, double moveDistanceGeo)
        //        {
        ...
        //            Distance3 endPt = moveAlongPointSequence(startILeg[0], startT[0], moveDistanceGeo, ptsGeo, endILeg, endT);
        ...
        //        // "pts" are geo coords, so uses AED distance calc.
        //        public static Distance3 moveAlongPointSequence(int startILeg, double startT, double moveDistanceMaya, Distance3[] pts, int[] endILeg, double[] endT)
        //        {
        //            endILeg[0] = startILeg;
        //            endT[0] = startT;
        //            double remainingMoveDI = moveDistanceMaya;
        //            Distance3 endPt = pts[startILeg];
        ...
        //                double legDI;//TODO = Distance3.calculateDistanceDD_AED_2D(pts[endILeg[0]], pts[endILeg[0] + 1]);
        ...
        //        public static Distance3 closestPointOnPointSequence(Distance3 loc, Distance3[] linePts)
        //        {
        //            int[] startILeg = new int[1];
        ...
        //        //   = LastElement(pts)
        //        // "pts" are geo coords, so uses AED distance calc.
        //        public static Distance3 closestPointOnPointSequence(Distance3 loc, IList<Distance3> pts, int[] closestILeg, double[] closestT)
        //        {
        //            Distance3 ret = new Distance3();
        //            closestILeg[0] = 0;
        //            closestT[0] = 0;
        ...
        //            {
        //                Distance3 p1 = pts[iLeg];
        //                Distance3 p2 = pts[iLeg + 1];
        //                double[] t = new double[1];

        //                Distance3 closestPt1 = closestPointOnLine_AndT_geo(loc, p1, p2, t);
        ...
        //        public static Distance2 closestPointOnPointSequence(Distance2 loc, Distance2[] pts)
        //        {
        //            int closestILeg;
        //            double closestT;
        ...
        //        // "loc" in geo coords.
        //        public static Distance2 closestPointOnPointSequence(Distance2 loc, Distance2[] pts, out int closestILeg, out double closestT)
        //        {
        //            Distance2 ret = new Distance2();
        ...
        //            {
        //                Distance2 p1 = pts[iLeg];
        //                Distance2 p2 = pts[iLeg + 1];
        //                double[] t = new double[1];

        //                Distance2 closestPt1 = closestPointOnLine_AndT_geo(loc, p1, p2, t);
        //                double distanceSq1 = distanceSquared(loc, closestPt1);
        ...
        //        public static double XAtY(double y, Distance2 a, Distance2 b)
        //        {
        //            double dy = b.Y - a.Y;
        //            double dx = b.X - a.X;
        ...
        //        public static Distance3 pointAlongLine_AED(Distance3 geoStartLocation, Distance3 geoEndLocation, double maxDistance)
        //        {
        //            // TODO: How pick an appropriate orthographic coordinate system?
        //            throw new NotImplementedException("pointAlongLine_AED");
        //            Geo.IContext context;
        //            Distance3 mayaStartLocation = context.FromWGS84(geoStartLocation);
        //            Distance3 mayaEndLocation = context.FromWGS84(geoEndLocation);
        //            double endDistance = Distance3.CalcDistance2(mayaStartLocation, mayaEndLocation);
        ...
        //            Distance3 mayaReachedPt = Lerp(mayaStartLocation, mayaEndLocation, maxDistance / endDistance);
        ...
        //        public static Distance3 hitLineOfPlayAtDistance(Distance3 startLocation, Distance3[] lopPts, double landingDistance)
        //        {
        //            int[] startILeg = new int[1];
        //            double[] startT = new double[1];
        //            Distance3 startPtOnSequence = closestPointOnPointSequence(startLocation, lopPts, startILeg, startT);

        //            Distance3 guessPt = startPtOnSequence;
        ...
        //            Distance3 shortPt = lopPts[endILeg[0] - 1];
        //            double shortDistance = calculateDistanceDD_AED(startLocation, shortPt);

        //            double[] t = new double[1];
        //            Distance3 closestPtOnLeg = closestPointOnLine_AndT_geo(startLocation, shortPt, longPt, t);
        ...
        //        public static Tuple<double, Distance2> pointDistanceToPolyline_AndClosestPoint(Distance2 point, Distance2[] poly)
        //        {
        //            double minDistanceSq = double.MaxValue;
        //            Distance2 closestPt = new Distance2();
        ...
        //                Distance2 closest1 = new Distance2();
        ...
        //            return new Tuple<double, Distance2>(minDistance, closestPt);
        //        }

        //        public static double pointDistanceSquaredToLine2D(Distance2 pt, Distance2 p1, Distance2 p2, ref Distance2 closestPt)
        //        {
        //            // (distanceSquared, closestPoint).
        //            Tuple<double, Distance2> ret = pointDistanceSqToLine2D_AndClosestPt(pt, p1, p2);
        ...
        //        public static Tuple<double, Distance2> pointDistanceSqToLine2D_AndClosestPt(Distance2 pt, Distance2 p1, Distance2 p2)
        //        {
        //            double t;
        //            Distance2 closestPt = linePointClosestToPoint2D(pt, p1, p2, out t);
        //            double distanceSq = distanceSquared(pt, closestPt);
        //            return new Tuple<double, Distance2>(distanceSq, closestPt);
        //        }

        //        public static Distance2 linePointClosestToPoint2D(Distance2 pt, Distance2 p1, Distance2 p2, out double t)
        //        {
        //            Distance2 delta = delta2D(p1, p2);
        ...
        //            else
        //            {
        //                closest = new Distance2(p1.X + t * delta.X, p1.Y + t * delta.Y);
        //            }
        ...
        //        public static Vector4 newGLVector(Distance3 v)
        //        {
        ...
        //        public static Distance3 asDouble3(Vector4 glVec)
        //        {
        //            // REQUIRE: glVec.W==1.
        //            return new Distance3(glVec.X, glVec.Y, glVec.Z);
        //        }
        ...
        //        public static Distance3 glMultiplyMV(Matrix4 lhsMat, Distance3 rhsVec)
        //        {
        ...
        //        // SIDE-EFFECT: changes m's elements.
        //        public static void translateGLMatrix(ref Matrix4 m, Distance3 translation)
        //        {
        ...
        //        //		// SIDE-EFFECT: changes m's elements.
        //        //		public static void preTranslateGLMatrix(float[] m, Distance3 translation) {
        ...
        //        public static Matrix4 glViewTransformForTwoPointUprightCamera(Distance3 cameraPt, Distance3 aimPt)
        //        {
        //            // Start with world coords, and identity matrix.
        //            Matrix4 m = Matrix4.Identity;

        //            // 1. Rotate around z-axis, until camera and aim have same x.
        //            Distance3 d3Aim = aimPt - cameraPt;
        //            Distance2 aimHeadingXY = d3Aim.To2D();
        ...
        //            Distance3 d3Aim_step1 = glMultiplyMV(m, d3Aim);

        //            // 2. Rotate around (new) x-axis, until camera and aim (also) have same y,
        //            //    and aim has a more negative z than camera.
        //            Distance2 aimHeadingYZ_step2 = new Distance2(d3Aim_step1.Y, d3Aim_step1.Z);
        ...
        //            Distance3 d3Aim_step2 = glMultiplyMV(m, d3Aim);
        ...
        //            //		preTranslateGLMatrix(m, Distance3.negate(cameraPt));
        //            //		Distance3 verifyOrigin = glMultiplyMV(m, cameraPt);
        ...
        //            Distance3 verifyDownZN = glMultiplyMV(m, aimPt);

        //            // Verify that camera is upright: two points that differ only in z should have same x.
        //            Distance3 verifyAboveAimZeroX = glMultiplyMV(m, aimPt + new Distance3(0, 0, 100));

        //            // Some different point.
        //            Distance3 otherPt = new Distance3(aimPt.Y, aimPt.X, aimPt.Z);
        //            Distance3 viewOtherPt = glMultiplyMV(m, otherPt);
        //            // Should have same x as viewOtherPt.
        //            Distance3 viewOtherPtSameX = glMultiplyMV(m, otherPt + new Distance3(0, 0, 100));
        ...
        //        public static Distance2 delta2D(double dblOrigonX, double dblOrigonY, double dblPointX, double dblPointY)
        //        {
        //            return new Distance2(dblPointX - dblOrigonX, dblPointY - dblOrigonY);
        //        }

        //        public static Distance2 delta2D(Distance2 origon, Distance2 point)
        //        {
        //            return new Distance2(point.X - origon.X, point.Y - origon.Y);
        //        }


        //        public static List<Distance2> intersectionsLineAndPolygon(Distance2 p1, Distance2 p2, IList<Distance2> polygon)
        //        {
        //            List<Distance2> intersections = new List<Distance2>();
        ...
        //            Distance2 p3 = new Distance2();
        //            foreach (Distance2 p4 in polygon)
        //            {
        //                if (p3 != null)
        //                {
        //                    Distance2 isect = new Distance2();
        ...
        //        {
        //            Distance2 closestPt = closestPointOnLineSegment(x, y, x1, y1, x2, y2);
        //            return distance(x, y, closestPt.X, closestPt.Y);
        //        }

        //        public static Distance2 closestPointOnLineSegment(Distance2 p, Distance2 p1, Distance2 p2)
        //        {
        //            return closestPointOnLineSegment(p.X, p.Y, p1.X, p1.Y, p2.X, p2.Y);
        //        }

        //        public static Distance2 closestPointOnLineSegment(double x, double y, double x1, double y1, double x2, double y2)
        //        {
        //            Distance2 delta = delta2D(x1, y1, x2, y2);

        //            // TBD: Use NearlyEquals?
        //            if ((delta.X == 0.0) & (delta.Y == 0.0))
        //                return new Distance2(x1, y1);
        ...
        //            if (t <= 0.0)
        //            {
        //                closestPt = new Distance2(x1, y1);
        //            }
        //            else if (t >= 1.0)
        //            {
        //                closestPt = new Distance2(x2, y2);
        //            }
        //            else
        //            {
        //                closestPt = new Distance2(x1 + (t * delta.X),
        //                                         y1 + (t * delta.Y));
        //            }
        ...
        //            Distance2 ptOnSegment = new Distance2();
        //            if (t < 0.0)
        //            {
        //                ptOnSegment.X = x1;
        //                ptOnSegment.Y = y1;
        ...
        //        public static double pointDistanceToLines(Distance2 goalPt, Distance2[] polygon)
        //        {
        //            Distance2 closestPt;
        //            return pointDistanceToLines(goalPt, polygon, out closestPt);
        //        }

        //        public static double pointDistanceToLines(Distance2 goalPt, Distance2[] polygon, out Distance2 closestPt)
        //        {
        //            closestPt = new Distance2();
        ...
        //                Distance2 closestPtOnSegment = closestPointOnLineSegment(goalPt, polygon[i], polygon[i2]);
        ...
        //        public static double pointDistanceToLines_AED(Distance2 goalPt, Distance2[] polygon, bool approximate, double cosLat)
        //        {
        //            double minDistance = double.MaxValue;
        ...
        //        public static double pointDistanceToLines(Distance3 goalPt, Distance3[] polygon)
        //        {
        //            double minDistance = double.MaxValue;
        ...
        //        // Perhaps default should be "approximate=true": This is a LOT slower if ask for accurate calculation,
        //        // for little gain (for distances less than 1 km).
        //        public static double pointDistanceToLines_AED(Distance3 goalGeo, Distance3[] polyGeo, bool approximate, double cosLat)
        //        {
        ...
        //        public static double polygonDistanceToPolygon(Distance3[] shape1, Distance3[] shape2)
        //        {
        //            double diClosest = double.MaxValue;

        //            for (int i = 0; i < shape1.Length; i++)
        //            {
        //                Distance3 p = shape1[i - 1];
        ...
        //        public static double polygonDistanceToPolygon(Distance2[] shape1, Distance2[] shape2)
        //        {
        //            double diClosest = double.MaxValue;

        //            for (int i = 0; i < shape1.Length; i++)
        //            {
        //                Distance2 p = shape1[i - 1];
        ...
        //        ////   for little benefit.
        //        //public static double polygonDistanceToPolygon_AED(Distance3[] shape1, Distance3[] shape2, bool approximate)
        //        //{
        //        //    double diClosest = double.MaxValue;

        //        //    // TBD: ASSUMES measuring on ActiveCourse.
        //        //    double cosLat = AppState.ActiveCourse.CosSiteCenterLatitude();
        //        //    foreach (Distance3 geoPt in shape1)
        //        //    {
        ...
        //        // This should probably ALWAYS be called with "approximate=true": Otherwise it is a LOT slower calculation,
        //        //   for little benefit.
        //        public static double polygonDistanceToPolygon_AED(Distance2[] shape1, Distance2[] shape2, bool approximate, double cosLat)
        //        {
        //            double diClosest = double.MaxValue;

        //            foreach (Distance2 geoPt in shape1)
        //            {
        ...
        //        //public static double pointDistanceToLine_AED(Distance3 ptdPoint, Distance3[] ptdPol)
        //        //{
        //        //    double maxValue = double.MaxValue;
        ...
        //        public static Distance2 extendLine2D(Distance2 p1, Distance2 p2, double di)
        //        {
        //            return extendLine2D(p1.X, p1.Y, p2.X, p2.Y, di);
        //        }

        //        public static Distance2 extendLine2D(double p1x, double p1y, double p2x, double p2y, double di)
        //        {
        //            double totDistance = distance(p1x, p1y, p2x, p2y) + di;
        //            double angle = getAngleDegrees(p1x, p1y, p2x, p2y);

        //            return new Distance2(p1x + totDistance * Math.Cos((angle / 180) * Math.PI), p1y + totDistance * Math.Sin((angle / 180) * Math.PI));
        //        }

        //        public static bool linesIntersectAt(Distance2 p1, Distance2 p2, Distance2 p3, Distance2 p4, ref Distance2 outPt, double tolerance = NearZero)
        //        {
        ...
        //                                             ref Distance2 outPt, double tolerance = NearZero)
        //        {
        ...
        //            Distance2 ret = linesIntersectAt(x1, y1, x2, y2, x3, y3, x4, y4, tolerance, ref overlap, ref overlap1, ref overlap2);
        ...
        //        public static Distance2 linesIntersectAt(double x1, double y1, double x2, double y2,
        //                                                double x3, double y3, double x4, double y4,
        //                                                double tolerance,
        ...
        //                                    new Distance2(xd, yd), new Distance2(xa, ya), new Distance2(xb, yb)).LengthSquared;
        ...
        //            if (asParallel)
        //            {
        //                Distance2 outP1 = new Distance2();

        //                linesOverlapOrTouch_Parallel(new Distance2(x1, y1), new Distance2(x2, y2), new Distance2(x3, y3), new Distance2(x4, y4), tolerance_scaled, ref overlap, ref overlap1, ref overlap2, ref outP1);
        ...
        //            Distance2 pr = new Distance2(rx, ry);
        //            bool checkY1 = firstIsShorter(x2 - x1, y2 - y1);
        //            bool checkY2 = firstIsShorter(x4 - x3, y4 - y3);
        //            Distance2 a = new Distance2(x1, y1);
        //            Distance2 b = new Distance2(x2, y2);
        //            Distance2 c = new Distance2(x3, y3);
        //            Distance2 d = new Distance2(x4, y4);
        ...
        //                    Distance2 pr1;
        //                    Distance2 pr2 = new Distance2(double.MaxValue, double.MaxValue);
        ...
        //        public static Distance2 pointDeltaToLineExtended(Distance2 pt, Distance2 p1, Distance2 p2)
        //        {
        //            Distance2 closest = closestPointOnLineExtended(pt, p1, p2);

        //            if (double.IsNaN(closest.X))
        //                return new Distance2(double.NaN, double.NaN);

        //            double deltaX = pt.X - closest.X;
        //            double deltaY = pt.Y - closest.Y;

        //            return new Distance2(deltaX, deltaY);
        //        }

        //        public static Distance2 closestPointOnPolygonExtended(Distance2 pt, Distance2[] pts)
        //        {
        //            Distance2 closestPt = new Distance2();
        ...
        //            {
        //                Distance2 p1 = pts[i == 0 ? pts.Length - 1 : i - 1];
        //                Distance2 p2 = pts[i];

        //                Distance2 close = closestPointOnLineExtended(pt, p1, p2);

        //                double di = Distance2.DistanceBetween(pt, close);
        ...
        //        public static Distance2 closestPointOnLineExtended(Distance2 pt, Distance2 p1, Distance2 p2)
        //        {
        //            Distance2 delta = delta2D(p1, p2);
        ...
        //        public static Distance2 tToPoint(double t, Distance2 p1, Distance2 delta)
        //        {
        //            double px = p1.X + t * delta.X;
        //            double py = p1.Y + t * delta.Y;

        //            return new Distance2(px, py);
        //        }

        //        public static bool linesOverlapOrTouch_Parallel(Distance2 a, Distance2 b, Distance2 c, Distance2 d, double tolerance, ref LineOverlap overlap, ref LineOverlap overlap1, ref LineOverlap overlap2, ref Distance2 op2)
        //        {
        //            Distance2 op1 = new Distance2();

        //            return linesOverlapOrTouch_Parallel(a, b, c, d, tolerance, ref overlap, ref overlap1, ref overlap2, ref op1, ref op2);
        //        }

        //        static bool handleZeroLengthLine(Distance2 a, Distance2 c, Distance2 d, double tolerance, out double t, out LineOverlap overlap)
        //        {
        //            Distance2 closestPt = closestPointOnLine_AndT(a, c, d, out t, false);
        ...
        //        // TODO: Isn't setting overlap1 or overlap2, when one line is zero-length.
        //        public static bool linesOverlapOrTouch_Parallel(Distance2 a, Distance2 b, Distance2 c, Distance2 d, double tolerance, ref LineOverlap overlap, ref LineOverlap overlap1, ref LineOverlap overlap2, ref Distance2 op1, ref Distance2 op2)
        //        {
        //            overlap1 = LineOverlap.Undefined;
        //            overlap2 = LineOverlap.Undefined;
        //            op1 = Distance2.NaN();
        ...
        //            Distance2 delta1 = b - a;
        //            Distance2 delta2 = d - c;
        ...
        //            if (Distance2.Equals(delta1, Distance2.Zero()))
        //            {
        //                return handleZeroLengthLine(a, c, d, tolerance, out t, out overlap);
        //            }
        //            else if (Distance2.Equals(delta2, Distance2.Zero()))
        //            {
        //                return handleZeroLengthLine(c, a, b, tolerance, out t, out overlap);
        //            }
        //            //			// -- OLD OLD --
        //            //			if (Distance2.Equals( delta1, Distance2.zero() ) || Distance2.Equals( delta2, Distance2.zero() )) {
        //            //				overlap = LineOverlap.BadData;
        //            //				return false;
        //            //			}
        ...
        //        public static LineOverlap whichCrossingType(Distance2 a, Distance2 b, Distance2 c, Distance2 d, double tolerance, Distance2 r, bool checkY1, bool checkY2, ref LineOverlap overlap1, ref LineOverlap overlap2)
        //        {
        ...
        //        public static Distance3 calculateFractionOnLines(Distance3[] lop, float fraction)
        //        {
        //            if (lop == null)
        ...
        //        public static double CalculateFractionFromGeo(Distance3[] lop, Distance3 geo, double diTotal = 0)
        //        {
        //            if (lop == null)
        //                return 0;
        ...
        //            Distance3 prevPt = new Distance3();
        //            double diPartial = 0.0f;
        //            foreach (Distance3 pt in lop)
        //            {
        //                if (prevPt == null)
        //                {   // First point.
        //                    prevPt = pt;
        ...
        //        private static double TotalLengthLines(Distance3[] lop)
        //        {
        //            Distance3 prevPt = new Distance3();
        //            double diTotal = 0.0f;
        ...
        public static Distance2 RotateByDegrees(Distance2 pos, double degrees)
        {
            return rotateByRadians(pos, degreesToRadians(degrees));
        }

        public static Distance2 rotateByRadians(Distance2 pos, double radians)
        {
            double cosR = Math.Cos(radians);
            double sinR = Math.Sin(radians);

            Distance2 ret = new Distance2(pos.X * cosR - pos.Y * sinR, pos.X * sinR + pos.Y * cosR);

            return ret;
        }

        //public static Distance2 rotateAtByDegrees(Distance2 origo, Distance2 point, double degrees)
        //{
        //    return rotateAtByRadians(origo, point, degreesToRadians(degrees));
        //}

        //        public static Distance2 rotateAtByRadians(Distance2 origo, Distance2 point, double radians)
        //        {
        //            Distance2 ret = new Distance2(origo);
        //            double cosR = Math.Cos(radians);
        //            double sinR = Math.Sin(radians);
        ...
        //        public static bool pointInsidePolygon(Distance2[] pts, Distance2 pt, bool testing = false)
        //        {
        //            if (pts == null)
        //                return false;
        ...
        //        public static Distance2 extendLine(Distance2 p1, Distance2 p2, double di)
        //        {
        //            double totalDi = distance(p1, p2) + di;
        //            double angle = getAngleDegrees(p1.X, p1.Y, p2.X, p2.Y);

        //            return new Distance2(p1.X + totalDi * Math.Cos((angle / 180) * Math.PI), p1.Y + totalDi * Math.Sin((angle / 180) * Math.PI));
        //        }
        ...
        //        public static double interpolateThreePoints(Distance3[] closestGeos, double[] minDists)
        //        {
        ...
        //            {
        //                Tuple<Distance3, double> geoWithDistOnly2 = interpolate2(closestGeos[0], minDists[0], closestGeos[1], minDists[1], true);
        ...
        //            Tuple<Distance3, double> geoWithDist2a = interpolate2(closestGeos[0], minDists[0], closestGeos[1], minDists[1], true);
        //            Tuple<Distance3, double> geoWithDist2b = interpolate2(geoWithDist2a.Item1, geoWithDist2a.Item2, closestGeos[2], minDists[2], true);
        //            // --- alternative --
        //            // Interpolate the FARTHEST 2 of the 3, then interpolate result with closest.
        //            Tuple<Distance3, double> geoWithDist1a = interpolate2(closestGeos[2], minDists[2], closestGeos[1], minDists[1], true);
        //            Tuple<Distance3, double> geoWithDist1b = interpolate2(geoWithDist1a.Item1, geoWithDist1a.Item2, closestGeos[0], minDists[0], true);
        ...
        //        private static double interpolate2_getZ(Distance3 closest1Geo, double minDistanceOrSq1, Distance3 closest2Geo, double minDistanceOrSq2, bool areDistanceSquareds)
        //        {
        //            Tuple<Distance3, double> geoWithDist = interpolate2(closest1Geo, minDistanceOrSq1, closest2Geo, minDistanceOrSq2, areDistanceSquareds);
        //            return geoWithDist.Item1.Z;
        //        }

        //        // When areDistanceSquareds, "minDistanceOrSq1/2" are "minDistanceSq"s,
        //        // when false, .. are "minDistance"s.
        //        // Return Pair<Distance3, Double>(resultGeo, resultDist).
        //        // If no points exist, return NaN.
        //        // NOTE: Despite "geo" in param names, is doing interpolation as if in
        //        //   an orthogonal coordinate system.
        //        private static Tuple<Distance3, double> interpolate2(Distance3 closest1Geo, double minDistanceOrSq1, Distance3 closest2Geo, double minDistanceOrSq2, bool areDistanceSquareds)
        //        {
        //            if ((closest1Geo == null) && (closest2Geo == null))
        //                return new Tuple<Distance3, double>(new Distance3(), double.NaN);
        //            else if ((closest2Geo == null) || (minDistanceOrSq1 == 0.0D))
        //                return new Tuple<Distance3, double>(closest1Geo, minDistanceOrSq1);
        //            else if ((closest1Geo == null) || (minDistanceOrSq2 == 0.0))
        //                return new Tuple<Distance3, double>(closest2Geo, minDistanceOrSq2);
        //            else
        //            {
        ...
        //                //				Dubious();
        //                Distance3 resultGeo = Lerp(closest1Geo, closest2Geo, wgt2norm);
        ...
        //                return new Tuple<Distance3, double>(resultGeo, resultDist);
        //            }
        //        }
        ...
        //        public static bool IsInsideTriangle(Distance3 pt, Distance3 a, Distance3 b, Distance3 c)
        //        {
        ...
        //        public static bool IsInsideTriangle(Distance2 pt, Distance2 a, Distance2 b, Distance2 c)
        //        {
