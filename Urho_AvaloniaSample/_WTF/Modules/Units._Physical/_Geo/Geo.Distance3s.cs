...
namespace WTF.Units
{
    public static partial class Geo
    {
        ...
        public class Distance3s : IList<Point3D>
        {
            #region --- data ----------------------------------------
            IContext Context;
            public readonly List<Distance3> Values = new List<Distance3>();
            #endregion
            ...
            {
                Distance3 value = ToOurContext(item);
            ...
            public Distance3 ToOurContext(Point3D value)
            {
                Distance3 finalValue = (Distance3)value.Pt;
                if (value.Context != Context)
                {   // Convert to our Context.
                    throw new NotImplementedException("Distance3.ToOurContext with different Context.");
